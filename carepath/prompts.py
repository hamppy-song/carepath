...
def build_id_to_name_mapping(
    drug_tsv: str = "/data/project/haerin/DREAMwalk/data/extracted/data/1_drug_to_protein.tsv",
    disease_tsv: str = "/data/project/haerin/DREAMwalk/data/extracted/data/2_indication_to_protein.tsv",
    ppi_tsv: str = "/data/project/haerin/DREAMwalk/data/extracted/data/3_protein_to_protein.tsv",
) -> Dict[str, str]:
    id2name = {}
