...
def build_id_to_name_mapping(
    drug_tsv='/data/project/haerin/DREAMwalk/data/extracted/data/1_drug_to_protein.tsv',
    disease_tsv='/data/project/haerin/DREAMwalk/data/extracted/data/2_indication_to_protein.tsv',
    ppi_tsv='/data/project/haerin/DREAMwalk/data/extracted/data/3_protein_to_protein.tsv',
):
    id2name = {}
...
def path_to_prompt(path, id2name, node2type):
