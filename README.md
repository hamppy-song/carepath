...
> Note: If your paper reports “averaging multiple XGBoost learners” but this repo uses a stacking ensemble (3×XGB + LogisticRegression meta-learner), keep the implementation that matches the reported setting.
